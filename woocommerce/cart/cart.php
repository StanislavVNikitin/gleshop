            ...
            <form class="woocommerce-cart-form" action="<?php echo esc_url(wc_get_cart_url()); ?>" method="post">
                ...
                <table class="table align-middle table-hover shop_table shop_table_responsive cart woocommerce-cart-form__contents">
                    ...
                    <tr>
                        ...
                        <th class="product-remove"><i class="fa-solid fa-trash-can"></i></th>
                    </tr>
                    ...
                    <tr>
                        <td colspan="6">
                            ...
                            <div class="coupon collapse input-group" id="collapseCoupon">
                                ...
                                <button type="submit" class="btn btn-danger button<?php echo esc_attr( wc_wp_theme_get_element_class_name( 'button' ) ? ' ' . wc_wp_theme_get_element_class_name( 'button' ) : '' ); ?>" name="apply_coupon" value="<?php esc_attr_e( 'Apply coupon', 'woocommerce' ); ?>"><?php esc_html_e( 'Apply coupon', 'woocommerce' ); ?></button>
                    ...
                    <?php endif;?>
                    <tr>
                        <td colspan="6" class="text-end actions">
                            <button type="submit" class="update-cart btn btn-outline-danger button<?php echo esc_attr( wc_wp_theme_get_element_class_name( 'button' ) ? ' ' . wc_wp_theme_get_element_class_name( 'button' ) : '' ); ?>" name="update_cart" value="<?php esc_attr_e( 'Update cart', 'woocommerce' ); ?>"><?php esc_html_e( 'Update cart', 'woocommerce' ); ?></button>
