    ...
    <div class="header-bottom sticky-top" id="header-nav">
        <nav class="navbar navbar-expand-md bg-dark" data-bs-theme="dark">
            <div class="container-fluid">
                ...
                <div>
                    <a href="<?php echo site_url('/wishlist/');?>" class="btn p-1 wishlist" id="wishlist">
                        <i class="fa-solid fa-heart"></i>
                        <span class="badge text-bg-warning wishlist-badge bg-warning rounded-circle wishlist-value wishlist_products_counter_number"></span>
                    </a>
